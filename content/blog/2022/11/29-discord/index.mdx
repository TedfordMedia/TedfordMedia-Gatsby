...
<Layout>
  Concept:  Create a Discord Bot that can dynamically communicate with Three.js clients running from a Node.js server with Socket.io. The bot deciphers text input and triggers updates to all connected Three.js clients.<br />  <br />
</Layout>
<YouTube youTubeId="https://www.youtube.com/watch?v=i8fYWOt6hKE" />
...
<Layout>
Here is the maon Node.js file app.js; as you can see it's a simple setup, with the pieces of code separated into classes in different .js files for both the server and client requirements.  <br />  <br />
