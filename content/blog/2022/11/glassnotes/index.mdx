...
<Layout>
Here's a basic Revit model converted to GLB and rendered in React-Three-Fiber. The glass is a PBR material which is more realistic than the standard glass material.
<br /><br />
</Layout>
